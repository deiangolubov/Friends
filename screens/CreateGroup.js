                    ...
                    <View style={styles.formContainer}>
                        ...
                        <View style={styles.optionContainer}>
                            <TouchableOpacity
                                style={[
                                    styles.optionButton,
                                    groupPublic === 'Yes' && styles.selectedOptionButton,
                                ]}
                                onPress={() => setGroupPublic('Yes')}
                            >
                            ...
                            <TouchableOpacity
                                style={[
                                    styles.optionButton,
                                    groupPublic === 'No' && styles.selectedOptionButton,
                                ]}
                                onPress={() => setGroupPublic('No')}
                            >
                                <Text style={styles.optionText}>No</Text>
                            </TouchableOpacity>
                        </View>
                        <Text style={styles.label}>Is visible?</Text>
                        <View style={styles.optionContainer}>
                            <TouchableOpacity
                                style={[
                                    styles.optionButton,
                                    groupVisible === 'Yes' && styles.selectedOptionButton,
                                ]}
                                onPress={() => setGroupVisible('Yes')}
                            >
                                <Text style={styles.optionText}>Yes</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                style={[
                                    styles.optionButton,
                                    groupVisible === 'No' && styles.selectedOptionButton,
                                ]}
                                onPress={() => setGroupVisible('No')}
                            >
                                <Text style={styles.optionText}>No</Text>
                            </TouchableOpacity>
                        </View>
                        ...
                        <TouchableOpacity style={[styles.loginButton, styles.cancelButton]} onPress={handleCancel}>
